...
def _execute_sum(mount_point):
    ...
    try:
        ...
        processutils.execute('./packages/smartupdate', '--s', '--romonly',
...
def update_firmware(node):
    ...
    :raises: ConnectionError, when the iLO connection fails.
    :raises: Error, when vmedia eject or insert operation fails.
    """
